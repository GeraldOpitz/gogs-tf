## Summary
Briefly describe what this Pull Request does within the Gogs TF
...
## Context
Explain why this change was needed — e.g., new feature, bugfix, or refactor 
...
2. Build Docker image (`docker build .`) and run `docker-compose up`, then visit http://localhost:5000/.
